...
TASK = (
    ...
    "— ДОМЕН (ориентируйся): на Threads заходит ЛИЧНОЕ / ПСИХОЛОГИЯ / твой ВЗГЛЯД, сухая крипта — "
    "слабее (см. блок ОРИЕНТИР в контексте — там топ-домены по Качеству). Флагман в 'слабом' домене "
    "(механика/крипта)? Тем СИЛЬНЕЕ вытяни человеческий/психологический угол ВНУТРИ него и веди ИМ — "
    "крипта заходит 'с лицом', не выжимкой.\n"

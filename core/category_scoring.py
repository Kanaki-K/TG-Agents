...
# Полу-затухание рецентности. 90 дней ≈ окно, за которое владелец выверил формулу подачи/дистилляции
# (последние 3-4 мес): свежий пост честнее старого, где механика (ссылки/хештеги/редактура) и крафт
# были слабее. Пост 4-мес давности весит ~½, годовой ~6%. Настраивается под смену регистра качества.
HALF_LIFE_DAYS = float(os.getenv("THREADS_HALFLIFE_DAYS", "90"))

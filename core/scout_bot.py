...
COMMANDS = {
    "scan": (
        "Проведи разведку: 1) scan_sources по ядру Тир-2; 2) при необходимости веб-поиск свежих "
        "трендов по нише; 3) отбери направления в нашу нишу (см. канон бренда в контексте); "

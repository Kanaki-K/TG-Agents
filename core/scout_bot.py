...
COMMANDS = {
    "scan": (
        "Проведи ГЛУБОКУЮ разведку по обоим трекам: 1) scan_sources и scan_telegram (track='crypto' И "
        "'ai') + веб-поиск; отдельно прогони ЦЕЛЕВЫЕ поиски пересечения AI×крипта (AI-агенты+платежи/"

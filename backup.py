...
SCRATCH = [
    ...
    "data/autopilot_on",                 # выключатель автопилота — НАМЕРЕННО не бэкапим: после
                                         # восстановления на новой машине автопилот обязан быть ВЫКЛЮЧЕН,
                                         # включает владелец осознанно (иначе он тихо начнёт публиковать)
]

        ...
        try:
            ...
            if verify.has_issues(sv) and verify.only_completeness(sv):
                ...
                if verify.has_redline(sv2):
                    ...
                    # на педантичном нюансе «The Open Platform ≠ TON Foundation» = $1.3 и ноль). Герой-цифры
                    # уже приведены к вебу; числовой остаток — нюанс, идёт пометкой владельцу в отложку.
